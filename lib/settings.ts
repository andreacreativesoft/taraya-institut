...
export const defaults: SiteSettings = {
  ...
  promo_label: "Offre exclusive",
  promo_title: "Éclat et sérénité de la rentrée",
  promo_body: "Vernis semi-permanent à 25€ (au lieu de 40€) pour tout soin visage Phyt's. Si dépose : 35€ au lieu de 50€. Offre valable du 1er au 30 septembre.",
