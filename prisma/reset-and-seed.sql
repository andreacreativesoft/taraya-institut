-- Taraya Institut — FULL RESET + SEED
-- ⚠️  This DELETES all existing services, pricing, and settings then re-inserts clean data.
-- Run in phpMyAdmin > SQL tab on the u885515688_taraya database.
...
-- ─── SITE SETTINGS (correct Belgian contact info) ──────────────────────────
